...
include "$language_dir/$language-language.php";		//where '$language' 
//echo "$language_dir/$language-language.php";
...
function poweredby () {
	global $sph_messages;
    print $sph_messages['Powered by'];?>  <a href="http://blog.csdn.net/ricky_hust/"><img src="anyelectro-logo.png" border="0" style="vertical-align: middle" alt="AnyElectro"></a>
